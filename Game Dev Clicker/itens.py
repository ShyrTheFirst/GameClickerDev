...
def lista_nomes_aprendiz():
    tirar_rand = []
    nome_final = ""
    segundo_nome = ['Sword', 'Dagger', 'Knife']
    primeiro_nome = ['killer','assassin']
    terceiro_nome = ['of worlds']
    quarto_nome = ['celestial','lengendary','royal']
...
def lista_nomes_espadachim():
    tirar_rand = []
    nome_final = ""
    segundo_nome = ['Sword', 'Dagger', 'Knife', 'Blade','Carver','Empaler','Splinter','Saber','Poniard','Scythe','Mower','Spit','Stub','Scimitar']
    primeiro_nome = ['killer','tearing','breaker','destroyer','assassin','vigilant','traitor','disgraceful','desolate','torturous','liberating','chaotic','acclaimed','slicer', 'abolishing']
    terceiro_nome = ['of worlds','of angels','of demons','of supernova','of chaos','of the clamor','of the oath','of extinction','of abolition','of virtue','of despair','of the chase','of the punishment', 'of the alliance','of the nobility']
    quarto_nome = ['celestial','demoniac','universal','final','shining','lengendary','ancestral','acclaimed','sworn in','reborn','avenger','eternal','wrathful','virtuos','punitive','royal']
    quant_nomes = random.randrange(1,5)
    lista_listas_nomes = [primeiro_nome,segundo_nome,terceiro_nome,quarto_nome]
    for num1 in range(0,quant_nomes):
        tirar_rand.append(lista_listas_nomes[num1])
...
def lista_nomes_guerreiro():
    tirar_rand = []
    nome_final = ""
    segundo_nome = ['Axe','Separator','Shackle','Shredder', 'Hatchet', 'Litter','Berdish','Bec de Corbin', 'Pernachs','Facade','Halberd','Franchise','War Axe']
    primeiro_nome = ['killer','tearing','breaker','destroyer','assassin','vigilant','traitor','disgraceful','desolate','torturous','liberating','chaotic','acclaimed','slicer', 'abolishing']
    terceiro_nome = ['of worlds','of angels','of demons','of supernova','of chaos','of the clamor','of the oath','of extinction','of abolition','of virtue','of despair','of the chase','of the punishment', 'of the alliance','of the nobility']
    quarto_nome = ['celestial','demoniac','universal','final','shining','lengendary','ancestral','acclaimed','sworn in','reborn','avenger','eternal','wrathful','virtuos','punitive','royal']
    quant_nomes = random.randrange(1,5)
...
def lista_nomes_arqueiro():
    tirar_rand = []
    nome_final = ""
    segundo_nome = ['Bow', 'Crossbow', 'Harpoon', 'Balista','Longbow','Falconet','Bolt','Bodoque','Heavy Crossbow']
    primeiro_nome = ['killer','tearing','breaker','destroyer','assassin','vigilant','traitor','disgraceful','desolate','torturous','liberating','chaotic','acclaimed','slicer', 'abolishing']
    terceiro_nome = ['of worlds','of angels','of demons','of supernova','of chaos','of the clamor','of the oath','of extinction','of abolition','of virtue','of despair','of the chase','of the punishment', 'of the alliance','of the nobility']
    quarto_nome = ['celestial','demoniac','universal','final','shining','lengendary','ancestral','acclaimed','sworn in','reborn','avenger','eternal','wrathful','virtuos','punitive','royal']
    quant_nomes = random.randrange(1,5)
...
def lista_nomes_mago():
    tirar_rand = []
    nome_final = ""
    segundo_nome = ['Staff', 'Flail', 'Fists', 'Club','Scepter','Mace','Bat','Stick','Wand','Rod','Kindling','Trunk']
    primeiro_nome = ['killer','tearing','breaker','destroyer','assassin','vigilant','traitor','disgraceful','desolate','torturous','liberating','chaotic','acclaimed','slicer', 'abolishing']
    terceiro_nome = ['of worlds','of angels','of demons','of supernova','of chaos','of the clamor','of the oath','of extinction','of abolition','of virtue','of despair','of the chase','of the punishment', 'of the alliance','of the nobility']
    quarto_nome = ['celestial','demoniac','universal','final','shining','lengendary','ancestral','acclaimed','sworn in','reborn','avenger','eternal','wrathful','virtuos','punitive','royal']
    quant_nomes = random.randrange(1,5)
